  ...
  return (
        ...
        return (
          ...
          <View style={styles.profileContainer}>
           ...
           <View>
            ...
            <CustomText label="Welcome" fontSize={16} fontFamily={fonts.medium} color="#2D2D2D" />
            <ImageFast source={Images.verfied} style={styles.verfiedImage} resizeMode="contain" />
            </View>
            <CustomText label="Nimra Sultan" fontSize={12} fontFamily={fonts.medium} color="#701A73" />
           </View>
          </View>
          <View style={{flexDirection: 'row', alignItems: 'center', gap: 10}}>
    ...
    >
      <View style={styles.container}>
        <ImageFast source={Images.cover2} style={{height: 120, width: '100%', marginBottom: 20}} resizeMode="contain" />
