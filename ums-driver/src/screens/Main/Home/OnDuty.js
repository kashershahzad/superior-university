...
const FeePaid = ({ feestatus, onShowUnpaid, onShowOffDuty }) => {
    ...
    >
      ...
      <Animated.View
        ...
        <InfoCard
          ...
          items={[
            { item: 'Bus number', itemValue: '03' },
            { item: 'Route', itemValue: '3-Faisalabad' },
            { item: 'Stops today', itemValue: '7 Stops' },
            { item: 'Students on board', itemValue: '38' },
            { item: 'Current coordinates', itemValue: '33.6007° N, 73.0679° E' },
          ]}
        />
      </Animated.View>
      <Animated.View
